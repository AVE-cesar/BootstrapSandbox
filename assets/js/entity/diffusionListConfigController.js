...
app.controller("DiffusionListConfigController", ["$scope", "$window", "$aside", 
"$log", "AppParameterRestService", 
	...
	log.info("inside DiffusionListConfigController, config.value: " + config.value);
	scope.configValue = angular.fromJson(config.value);

	/** Saves config into database */
	scope.saveConfig = function (configValue) {
		log.info("call method saveConfig inside DiffusionListConfigController");
