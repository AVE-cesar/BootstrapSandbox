...
app.controller("VbsFlowUnitDiffusionA2015ConfigController", ["$scope", "$window", "$aside", 
"$log", "AppParameterRestService", 
	...
	log.info("inside VbsFlowUnitDiffusionA2015ConfigController, config.value: " + config.value);
	scope.configValue = angular.fromJson(config.value);

	/** Saves config into database */
	scope.saveConfig = function (configValue) {
		log.info("call method saveConfig inside VbsFlowUnitDiffusionA2015ConfigController");
