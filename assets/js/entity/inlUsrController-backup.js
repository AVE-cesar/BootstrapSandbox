...
app.controller("InlUsrController", ["$scope", "$window", "$aside", "PlaceholderTextService", 
"$log", "InlUsrRestService", "InlUsrRestSearchService", 
		"InlUsrRestIndexService", "InlUsrRestMassDeleteService",
...
/*log.info("inside InlUsrController, config.value: " + config.value);
...
var crudAside = c({
	scope: scope,
	template: "assets/tpl/apps/crud-inlUsr.html",
	show: !1,
	placement: "left",
	backdrop: !1,
...
var searchAside = c({
	scope: scope,
	template: "assets/tpl/apps/inlUsr/inlUsrSearch.html",
	show: !1,
	placement: "left",
	backdrop: !1,
	animation: "am-slide-left"
...
scope.editItem = function(item) {
	...
	inlUsrRestService.get({id: item.id}, function success(result) {
		scope.item = result;
...
scope.saveItem = function() {
	...
	var onSaveSuccess = function success(data) {
		...
		window.showAlert = function(){
			...
			var userALert = alertService({
	                    title: "SUCCESS:",
	                    content: '<BR>Your inlUsr have been <i>created or updated</i>. You can find it int the result table. See <a href="#"><B>older messages</B></a> !',
	                    placement: "top-right",
	                    type: "theme",
	...
	var onSaveError = function (result) {
			window.showAlert = function(){
				var userALert = alertService({
		                    title: "ERROR:",
		                    content: "<BR>Your inlUsr haven't been created. Try again !",
		                    placement: "top-right",
		                    type: "theme",
		                    container: ".alert-container-top-right",
		                    show: !1,
		...
		if (!b) {
			...
			inlUsrRestMassDeleteService.massDelete({id: ids}, function success(data) {
				...
				window.showAlert = function(){
				    var userALert = alertService({
				                    title: "SUCCESS:",
				                    content: '<BR>Your inlUsr have been deleted. The result table have been <b>updated</b>.',
				                    placement: "top-right",
				                    type: "theme",
				                    container: ".alert-container-top-right",
				                    show: !1,
